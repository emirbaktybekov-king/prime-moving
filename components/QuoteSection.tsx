    ...
    <>
      <section id="quote" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-lg border border-orange-100">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-400 focus:border-transparent transition-colors"
                    required
                  />
                </div>
                <div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-gray-700 font-medium mb-2">
                    {t('quote.moveDate')} <span className="text-red-500">*</span>
                  </label>
                  <button
                    type="button"
                    onClick={() => setShowDatePicker(true)}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-400 focus:border-transparent transition-colors bg-white text-left flex items-center justify-between hover:bg-gray-50"
                  >
                    <span className={displayDate ? 'text-gray-900' : 'text-gray-500'}>
                      {displayDate || t('quote.selectDate')}
                    </span>
              ...
              <div>
              <label className="block text-gray-700 font-medium mb-2">
                    {t('quote.fromAddress')} <span className="text-red-500">*</span>
                  </label>
                   <input
                    type="text"
                    name="fromAddress"
                  ...
                  />
                   <label className="block text-gray-700 font-medium mb-2">
                    {t('quote.toAddress')} <span className="text-red-500">*</span>
                  </label>
                   <input
                    type="text"
                    name="toAddress"
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows={4}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-400 focus:border-transparent transition-colors resize-vertical"
                  placeholder={t('quote.messagePlaceholder')}
                ></textarea>
              </div>
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-orange-400 to-orange-500 text-white font-bold py-3 rounded-lg hover:from-orange-500 hover:to-orange-600 transition-all shadow-lg"
              >
                {t('quote.submit')}
              </button>
            </form>
